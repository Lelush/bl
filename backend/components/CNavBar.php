...
//        echo Html::a(Html::img(HImage::getSrc('img','/img/logo.png')), '#', ['id'=>'toggle_sidemenu_logo','class'=>'navbar-left cropper-container p10', 'style'=>'height:100%']);
        echo Html::a($this->brandLabel,$this->brandUrl === false ? Yii::$app->homeUrl : $this->brandUrl, $this->brandOptions);
        echo Html::tag('span',null,['id'=>'toggle_sidemenu_l','class'=>'ad ad-lines']);
