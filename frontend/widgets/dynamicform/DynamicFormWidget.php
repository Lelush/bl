...
namespace frontend\widgets\dynamicform;
...
class DynamicFormWidget extends \yii\base\Widget
{
    ...
    public $min = 1;
    /**
     * Отчищать ли форму при загрузке виджета
     * @var bool
     */
    public $empty = false;
    ...
    public function init()
    {
        ...
        if (!isset($this->empty)) {
            throw new InvalidConfigException("The 'empty' property must be set.");
        }
    ...
    protected function initOptions()
    {
        ...
        $this->_options['empty']           = $this->empty;
